...
- Again for ethical considerations, delays were hardcoded into the program in optimal locations, to "enable processes to complete in reliable method" and maybe to "prevent theft", additionally async downloads are limited to 2; FilesCollect-Py is intended to make tasks easier, not specifically shorten the time doing the task. 
