...
def display_menu(base_url_location_eia, file_type_search_fvb, standard_mode_3nc, asynchronous_mode_4fn):
    ...
    print("") 
    print("                      5. Set Tor Port Number")
    print(f"                            ({TOR_PORT})")
    print("\n\n\n")
    print("Select :- Menu Options = 1-5, Begin Rip = B, Exit Menu = X: ", end='')

def handle_menu(base_url_location_eia, file_type_search_fvb, standard_mode_3nc, asynchronous_mode_4fn, TOR_PORT, save_settings_func, begin_rip_message_func, scrape_and_download_func, exit_message_func):
    while True:
        display_menu(base_url_location_eia, file_type_search_fvb, standard_mode_3nc, asynchronous_mode_4fn, TOR_PORT)
